            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-3">
                        <a href="#" class="w-10 h-10 bg-purple-700 hover:bg-purple-600 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <p class="text-purple-200 text-sm">info@angkatanmuda.com</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-purple-700/50 pt-8">
                <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                    <p class="text-purple-200 text-sm text-center md:text-left">
                        &copy; {{ date('Y') }} {{ $settings->ranting_nama }}. All rights reserved.
                    </p>
